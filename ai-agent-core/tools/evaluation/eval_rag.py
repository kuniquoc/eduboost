"""Evaluate RAG retrieval hit rate against a gold dataset."""
...
def evaluate_rag(gold_dataset_path, threshold=80):
    ...
    # Load the versioned seed unless FAISS_INDEX_PATH points at another index.
    index_path = os.getenv("FAISS_INDEX_PATH") or "resources/faiss-seed/faiss_index"
...
if __name__ == "__main__":
    evaluate_rag("data/gold_dataset/rag_eval.json", threshold=80)
