...
def create_judge_client():
    """Tạo OpenAI client cho GPT-4o judge."""
...
def get_evaluations():
    """Trả về (evaluations_list, default_base_url) từ config."""
    cfg = load_config()
    return cfg["evaluations"], cfg.get("default_base_url", "http://localhost:8000/v1")
