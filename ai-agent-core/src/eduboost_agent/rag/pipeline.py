# src/eduboost_agent/rag/pipeline.py
...
from eduboost_agent.rag.reranker import CrossEncoderReranker
from eduboost_agent.rag.llm_generator import LLMGenerator
...
class RAGPipeline:
    ...
    def __init__(
        self,
        index_path: str = "var/faiss-pipeline/faiss_index",
