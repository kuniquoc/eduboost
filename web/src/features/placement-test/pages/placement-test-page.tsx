...
import { placementTestService } from '@/features/placement-test/api/placement-test.service';
...
import type { PlacementQuestionDto, CompletePlacementResponse, QuizReviewItemDto } from '@/features/practice/types';
...
export function PlacementTestPage() {
  ...
  } = useAiExplanation({ storeOfflineExplanation: true });
  ...
  const requestDetailedExplanation = useCallback(
    ...
    async (item: QuizReviewItemDto): Promise<string> => {
      return await requestAiExplanation({
        key: item.questionId,
        question: item.text,
