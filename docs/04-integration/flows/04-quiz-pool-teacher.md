# Luồng: Quiz Pool Teacher

> Trạng thái: ✅

## Trigger

Teacher pool dashboard
...
sequenceDiagram
    ...
    User->>Web: Teacher pool dashboard
    Web->>API: REST call
...
| 3 | server | PoolRepository.cs, pool-dashboard.tsx | POST /api/pool/generate, create-test | Repository logic |
