# Luồng: AI Studio Review + Publish
...
| 3 | server | quiz-review-page.tsx, QuizzesRepository.cs | /api/quizzes/{id}/questions, publish | Repository logic |
