# Luồng: Entry Test Legacy

> Trạng thái: 🔧

## Trigger

Dashboard redirect → entry-test page
...
sequenceDiagram
    ...
    User->>Web: Dashboard redirect → entry-test page
    Web->>API: REST call
...
| 3 | server | QuizzesRepository.GenerateEntryTestAsync | generate-entry-test, entry-test/submit | Repository logic |
...
Generator stub placeholder; không AI thật
